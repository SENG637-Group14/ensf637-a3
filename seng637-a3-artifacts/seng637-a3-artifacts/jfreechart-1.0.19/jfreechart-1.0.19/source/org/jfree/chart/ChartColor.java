...
public class ChartColor extends Color {
    ...
    public static Paint[] createDefaultPaintArray() {
        ...
        return new Paint[] {
            ...
            Color.pink,
            Color.gray,
            jfree.chart.ChartColor.DARK_RED,
            jfree.chart.ChartColor.DARK_BLUE,
            jfree.chart.ChartColor.DARK_GREEN,
            jfree.chart.ChartColor.DARK_YELLOW,
            jfree.chart.ChartColor.DARK_MAGENTA,
            jfree.chart.ChartColor.DARK_CYAN,
            Color.darkGray,
            jfree.chart.ChartColor.LIGHT_RED,
            jfree.chart.ChartColor.LIGHT_BLUE,
            jfree.chart.ChartColor.LIGHT_GREEN,
            jfree.chart.ChartColor.LIGHT_YELLOW,
            jfree.chart.ChartColor.LIGHT_MAGENTA,
            jfree.chart.ChartColor.LIGHT_CYAN,
            Color.lightGray,
            jfree.chart.ChartColor.VERY_DARK_RED,
            jfree.chart.ChartColor.VERY_DARK_BLUE,
            jfree.chart.ChartColor.VERY_DARK_GREEN,
            jfree.chart.ChartColor.VERY_DARK_YELLOW,
            jfree.chart.ChartColor.VERY_DARK_MAGENTA,
            jfree.chart.ChartColor.VERY_DARK_CYAN,
            jfree.chart.ChartColor.VERY_LIGHT_RED,
            jfree.chart.ChartColor.VERY_LIGHT_BLUE,
            jfree.chart.ChartColor.VERY_LIGHT_GREEN,
            jfree.chart.ChartColor.VERY_LIGHT_YELLOW,
            jfree.chart.ChartColor.VERY_LIGHT_MAGENTA,
            jfree.chart.ChartColor.VERY_LIGHT_CYAN
        };
    }
